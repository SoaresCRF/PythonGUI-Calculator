...
class ButtonsGrid(QGridLayout):
    def __init__(self, display: 'Display', info: 'Info', window: 'MainWindow', *args, **kwargs) -> None:
        ...
        self.window = window
        self._equation = ''
        self._equationInitialValue = 'My equation'
        self._left = None
        self._right = None
        self._op = None
    ...
    def _configLeftOp(self, text):
        ...
        if not isValidNumber(displayText) and self._left is None:
            self._showError('Inform something.')
            return
    ...
    def _eq(self):
        ...
        try:
            ...
            self._showError('This equation cannot be performed.')
        except Exception:
            self._showError('Unknown error.')

        self.display.clear()
        self.info.setText(f'{self.equation} = {converToNumber(result)}')
        self._left = result
        self._right = None
        self.display.setFocus()
